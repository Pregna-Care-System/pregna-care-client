...
const BabyNameApp = () => {
  ...
  const babyNames = {
    male: [
      "Alexander", "Benjamin", "Christopher", "Daniel", "Ethan", "Felix", "Gabriel", "Henry", "Isaac", "Jack",
      "Liam", "Mason", "Noah", "Oliver", "Patrick", "Quentin", "Ryan", "Samuel", "Thomas", "Victor",
      "William", "Xander", "Yusuf", "Zachary", "Adrian", "Bryan", "Caleb", "Damian", "Elijah", "Finn",
      "George", "Harrison", "Ivan", "Jacob", "Kevin", "Leonard", "Matthew", "Nathan", "Owen", "Peter",
      "Quincy", "Robert", "Sebastian", "Tristan", "Ulysses", "Vincent", "Wyatt", "Xavier", "Yannis", "Zane"
    ],
    female: [
      "Amelia", "Bella", "Charlotte", "Daisy", "Eleanor", "Fiona", "Grace", "Hannah", "Isla", "Julia",
      "Katherine", "Lillian", "Mia", "Natalie", "Olivia", "Penelope", "Quinn", "Rebecca", "Sophia", "Tatiana",
      "Ursula", "Victoria", "Willow", "Xena", "Yasmine", "Zoe", "Alice", "Beatrice", "Clara", "Delilah", "Emma",
      "Freya", "Gabriella", "Hazel", "Ivy", "Jasmine", "Kiara", "Lucy", "Madeline", "Nora", "Ophelia",
      "Paisley", "Rosalie", "Scarlett", "Tessa", "Uma", "Veronica", "Wendy", "Xiomara", "Yvette", "Zelda"
    ],
    "": [
      "Alexander", "Benjamin", "Christopher", "Daniel", "Ethan", "Felix", "Gabriel", "Henry", "Isaac", "Jack",
      "Liam", "Mason", "Noah", "Oliver", "Patrick", "Quentin", "Ryan", "Samuel", "Thomas", "Victor",
  ...
  const popularSearchTerms = [
    "Alexander", "Isabella", "William", "Charlotte", "Benjamin", "Victoria", "James",
    "Oliver", "Amelia", "Lucas", "Sophia"
  ];
  ...
  const generateBabyName = (nameForm: { gender: string | undefined; birthDate: any; parentThoughts: any; }) => {
    ...
    const nameMeaning = nameMeanings[generatedName] || "A beautiful name with deep significance inside. You can choose gender for baby for more information. ";
    ...
    <div className="bg-white rounded-xl shadow-lg p-8 mb-12 mt-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-purple-800 text-center md:text-left">
            🎇 Begin Your Journey
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            Choosing a name is one of the most significant decisions you'll make for your child.
            It's more than just a word—it's the beginning of their story, a reflection of your hopes,
            and a gateway to their future.
          </p>
        ...
        <section className="max-w-7xl mx-auto p-6 bg-white rounded-xl shadow-lg my-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="md:w-1/2 space-y-4">
              ...
              <button onClick={() => handleGenerateBabyName()}
          ...
          {selectedName && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
              <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-lg">
                ...
                <p className="text-gray-600 mt-2"><strong>Created on:</strong> {selectedName.createdAt}</p>
                <p className="text-gray-700 mt-2"><strong>Date of birth:</strong> {selectedName.birthDate}</p>
                <p className="text-gray-700 mt-2"><strong>Gender:</strong> {selectedName.gender}</p>
                <p className="text-gray-700 mt-2"><strong>Origin:</strong> {selectedName.origin}</p>
                <p className="text-gray-700 mt-2"><strong>Theme:</strong> {selectedName.theme}</p>
                <p className="text-gray-700 mt-2"><strong>Style:</strong> {selectedName.style}</p>
                <p className="text-gray-700 mt-2"><strong>Personality:</strong> {selectedName.personality}</p>
                <p className="text-gray-700 mt-2"><strong>Culture:</strong> {selectedName.culture}</p>
                <p className="text-gray-700 mt-2"><strong>Zodiac:</strong> {selectedName.zodiacSign}</p>
                <p className="text-gray-700 mt-2"><strong>Meaning:</strong> {selectedName.nameMeaning}</p>
                <p className="text-gray-700 mt-2"><strong>Parent's Thoughts:</strong> {selectedName.parentThoughts}</p>
        ...
        <section className="max-w-7xl mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {popularNames.map((name) => (
              <div key={name.name} className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform hover:scale-105">
