...
const BabyShopApp = () => {
  ...
  const news = [
    { id: 1, title: "Choosing the Right Baby Formula", date: "2024-01-15", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b", description: "Guide to selecting the best formula for your baby's needs" },
    { id: 2, title: "Baby Sleep Tips", date: "2024-01-14", image: "https://images.unsplash.com/photo-1588854337236-6889d631faa8", description: "Expert advice for better baby sleep patterns" },
    { id: 3, title: "First-Time Parent Guide", date: "2024-01-13", image: "https://images.unsplash.com/photo-1588854337236-6889d631faa8", description: "Essential tips for new parents" },
    { id: 4, title: "Baby Development Milestones", date: "2024-01-12", image: "https://images.unsplash.com/photo-1576043061888-8751653f46af", description: "Track your baby's growth and development" },
    { id: 5, title: "Nutrition for Nursing Mothers", date: "2024-01-11", image: "https://images.unsplash.com/photo-1595341888016-a392ef81b7de", description: "Healthy eating tips for breastfeeding moms" },
    { id: 6, title: "Baby-Proofing Your Home", date: "2024-01-10", image: "https://images.unsplash.com/photo-1588854337236-6889d631faa8", description: "Essential safety tips for your home" }
  ];
  ...
  const brands = [
    "Pampers", "Huggies", "Gerber", "Fisher-Price", "Chicco", "Graco", "Philips Avent", "Tommee Tippee"
  ];
                  ...
                  >
                    <div className="relative rounded-lg overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent p-6 flex flex-col justify-end">
                        ...
                        <p className="text-white/80">Discover our collection of {categories[index].name.toLowerCase()}</p>
                      </div>
                    </div>
                  </div>
                );
